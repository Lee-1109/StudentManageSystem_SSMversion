...
<form action="updateTeacherController">
    <table>
        <tr><td>工号:</td><td><input type="text" name="teacherId" value="${teacher.teacherId}"/></td></tr>
        <tr><td>姓名:</td><td><input type="text" name="teacherName" placeholder="${teacher.teacherName}"/></td></tr>
